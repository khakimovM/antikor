...
export function JsonLd({ locale }: Props) {
  ...
  const organization = {
    ...
    knowsAbout: [
      ...
      'antikorroziya fergana',
      "antikorroziya farg'ona",
      'antikorroziya navoiy',
      'uz antikorroziya',
      'uzb antikorroziya',
      ...
      'gidroizolyatsiya fergana',
      "gidroizolyatsiya farg'ona",
      'uz gidroizolyatsiya',
      ...
      'Антикоррозийные работы Фергана',
      'Гидроизоляция Узбекистан',
      'Гидроизоляция Ташкент',
      'Гидроизоляция Фергана',
      'Футеровочные работы Узбекистан',
      'Футеровочные работы Фергана',
    ...
    sameAs: [
      'https://www.uzximzashita.uz/ru',
      'https://www.uzximzashita.uz/uz',
      'https://www.uzximzashita.uz/en',
    ],
  };
